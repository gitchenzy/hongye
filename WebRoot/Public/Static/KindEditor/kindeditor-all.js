...
KindEditor.plugin('flash', function(K) {
    var self = this, name = 'flash', lang = self.lang(name + '.'),
		...
		uploadJson = K.undef(self.uploadJson, self.basePath + 'upload.ashx'),
		...
		edit : function() {
			...
			if (allowFlashUpload) {
				var uploadbutton = K.uploadbutton({
					...
					url: K.addParam(uploadJson, 'type=flash&uploadPath=' + uploadPath),
...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			...
			'<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + target + '" action="' + K.addParam(uploadJson, 'type=image&uploadPath=' + uploadPath) + '">',
			//file
			'<div class="ke-dialog-row">',
			hiddenElements.join(''),
	...
	self.plugin.fileDialog = function(options) {
		...
		if (allowFileUpload) {
			var uploadbutton = K.uploadbutton({
				button : K('.ke-upload-button', div)[0],
				fieldName : filePostName,
				url: K.addParam(uploadJson, 'type=file&uploadPath=' + uploadPath),
				extraParams : extraParams,
				afterUpload : function(data) {
					dialog.hideLoading();
					if (data.error === 0) {
		...
		edit : function() {
			...
			if (allowMediaUpload) {
				var uploadbutton = K.uploadbutton({
					...
					fieldName : filePostName,
					extraParams : extraParams,
					url: K.addParam(uploadJson, 'type=media&uploadPath=' + uploadPath),
					afterUpload : function(data) {
						dialog.hideLoading();
						if (data.error === 0) {
							var url = data.url;
...
KindEditor.plugin('multiimage', function(K) {
	...
	self.plugin.multiImageDialog = function(options) {
		...
		var swfupload = K.swfupload({
			...
			uploadUrl: K.addParam(uploadJson, 'type=image&uploadPath=' + uploadPath),
